...
import com.ffx.novelreader.treader.util.DisplayUtils;
import com.ffx.novelreader.treader.view.CircleImageView;
...
public class SettingDialog extends Dialog {
    // 文本亮度
    @Bind(R.id.tv_dark)
    TextView tv_dark;               //暗文本
    @Bind(R.id.sb_brightness)
    SeekBar sb_brightness;          //亮度进度条
    @Bind(R.id.tv_bright)
    TextView tv_bright;             //亮文本
    @Bind(R.id.tv_xitong)
    TextView tv_xitong;             //系统文本

    // 文本尺寸
    @Bind(R.id.tv_subtract)
    TextView tv_subtract;           //字体尺寸减
    @Bind(R.id.tv_size)
    TextView tv_size;               //字体尺寸
    @Bind(R.id.tv_add)
    TextView tv_add;                //字体尺寸加
    @Bind(R.id.tv_size_default)
    TextView tv_size_default;       //字体尺寸默认

    // 文本字体
    @Bind(R.id.tv_default)
    TextView tv_default;            //字体系统默认
    @Bind(R.id.tv_qihei)
    TextView tv_qihei;              //羿创旗黑字体
    @Bind(R.id.tv_fzxinghei)
    TextView tv_fzxinghei;          //行黑字体
    @Bind(R.id.tv_fzkatong)
    TextView tv_fzkatong;           //卡通字体
    @Bind(R.id.tv_bysong)
    TextView tv_bysong;             //宋体

    // 背景
    @Bind(R.id.iv_bg_default)
    CircleImageView iv_bg_default;  //背景默认
    @Bind(R.id.iv_bg_1)
    CircleImageView iv_bg1;         //背景1
    @Bind(R.id.iv_bg_2)
    CircleImageView iv_bg2;         //背景2
    @Bind(R.id.iv_bg_3)
    CircleImageView iv_bg3;         //背景3
    @Bind(R.id.iv_bg_4)
    CircleImageView iv_bg4;         //背景4
